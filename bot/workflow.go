...
func BotWorkflow(ctx workflow.Context, url string) (*CronResult, error) {
	...
	err := workflow.ExecuteActivity(ctx1, BotActivity, lastRunTime, thisRunTime, url).Get(ctx, &result)
